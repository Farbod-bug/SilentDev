		...
		<div class="container-fluid">
			<div class="row">
              ...
              <!-- Title -->
							...
							<h5 class="fw-light mb-4">برای دریافت رمز عبور جدید، جزعیات خواسته شده را وارد کنید</h5>
							...
							<form action="{{ route('reset_password_post') }}" method="POST">
								...
								<div class="mb-4">
									...
									<label for="exampleInputEmail1" class="form-label">رمز عبور جدید</label>
									<div class="input-group input-group-lg">
										<span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="bi bi-lock-fill"></i></span>
										<input type="password" name="password" class="form-control border-0 bg-light rounded-end ps-1" placeholder="****" id="exampleInputEmail1">
                                        @error('password')
                                ...
                                <!-- retryPassword -->
								<div class="mb-4">
									<label for="exampleInputEmail1" class="form-label">تکرار رمز عبور</label>
									<div class="input-group input-group-lg">
										<span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="bi bi-lock-fill"></i></span>
										<input type="password" name="retryPassword" class="form-control border-0 bg-light rounded-end ps-1" placeholder="****" id="exampleInputEmail1">
                                        @error('retryPassword')
                                        <p class="invalid-feedback d-block">
                                            <strong>{{ $message }}</strong>
                                        </p>
