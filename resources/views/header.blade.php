			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll ms-auto">
                    ...
                    @if(!(auth()->guard('clients')->check()))
					    <a href="{{ route('register') }}"><button class="btn btn-danger-soft mb-0 me-2"><i class="fas fa-sign-in-alt me-2"></i>ثبت نام</button></a>
                        <a href="{{ route('login') }}"><button class="btn btn-danger-soft mb-0"><i class="fas fa-sign-in-alt me-2"></i>ورود</button></a>
                    @endif
				</ul>
				<!-- Nav Main menu END -->
			</div>
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                @if(auth()->guard('clients')->check())
					...
					<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
						<img class="avatar-img rounded-circle" src={{ asset("assets/images/avatar/user.jpg") }} alt="avatar">
					</a>
						...
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow" src={{ asset("assets/images/avatar/user.jpg") }} alt="avatar">
								</div>
								<div>
									<p class="h6" href="#">{{ auth()->guard('clients')->user()->name }}</p>
								    <p class="small m-0">{{ auth()->guard('clients')->user()->email }}</p>
								</div>
							</div>
						</li>
						<!-- Links -->
						<li><a class="dropdown-item" href="{{ route('profile_index') }}"><i class="bi bi-person fa-fw me-2"></i>ویرایش</a></li>
		...
		<div class="container px-0">
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse2">
				...
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<!-- Nav item 3 link -->
					<li class="nav-item"><a class="nav-link" href="{{ route('courses') }}">دوره های آموزشی</a></li>
