...
<main>
                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('contact_post') }}" method="POST">
                        ...
                        <div class="mb-4 bg-light-input">
                            ...
                            <input type="text" class="form-control form-control-lg" id="yourName" name="name" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="mb-4 bg-light-input">
                            ...
                            <input type="email" class="form-control form-control-lg" id="emailInput" name="email" value="{{ old('email') }}">
                            @error('email')
                                <p class="invalid-feedback d-block">
                                    <strong>{{ $message }}</strong>
                                </p>
                        ...
                        <div class="mb-4 bg-light-input">
                            ...
                            <textarea class="form-control" id="textareaBox" rows="4" name="description" >{{ old('description') }}</textarea>
                            @error('description')
                                <p class="invalid-feedback d-block">
                                    <strong>{{ $message }}</strong>
                                </p>
    ...
    <section class="pt-5 pb-5" style="background-image:url(assets/images/element/map.svg); background-position: center left; background-size: cover;">
        <div class="container">
            <div class="row">
                    ...
                    <div class="card card-body bg-primary shadow py-5 text-center h-100">
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-item mb-3">
                                <a href="#" class="text-white"> <i class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>تهران، میدان آزادی، جنب مترو شادمان، مجتمع صدف </a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3">
                                <a href="#" class="text-white"> <i class="fas fa-fw fa-phone-alt me-2"></i>09320000000 </a>
                            </li>
                            <!-- Email id -->
                ...
                <div class="col-lg-4 mt-lg-0">
                    <div class="card card-body shadow py-5 text-center h-100">
                        ...
                        <ul class="list-inline mb-0">
                            <!-- Address -->
                            <li class="list-item mb-3 h6 fw-light">
                                <a href="#"> <i class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>تهران، چهارراه ولیعصر، نرسیده به خیابان کریم خان زند </a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3 h6 fw-light">
    ...
    {{-- <section class="pt-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <iframe class="w-100 h-400px grayscale rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3239.6061159733226!2d51.40979635956936!3d35.71130927269164!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e0114804ce6b1%3A0xef2337025f6d4dab!2z2KfYs9iq2KfZhiDYqtmH2LHYp9mG2Iwg2KrZh9ix2KfZhtiMINmF2YbYt9mC2Ycg27bYjCDZhduM2K_Yp9mGINmI2YTbjNi52LXYsdiMINin24zYsdin2YY!5e0!3m2!1sfa!2s!4v1681550832738!5m2!1sfa!2s" width="600" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section> --}}
