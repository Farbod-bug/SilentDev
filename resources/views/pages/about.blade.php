        ...
        <div class="container">
            ...
            <div class="row g-4 mt-0 mt-lg-5">
                ...
                <div class="col-6 col-md-4">
                    <div class="row g-4">
                        ...
                        <div class="col-10 col-lg-6">
                            <img class="rounded-4" src={{ asset("assets/images/about/05.jpg") }} alt="">
                        </div>
                        <!-- Image -->
                        <div class="col-12">
                            <img class="rounded-4" src={{ asset("assets/images/about/03.jpg") }} alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4 position-relative">
                    ...
                    <!-- Image -->
                    <img class="rounded-4" src={{ asset("assets/images/about/09.jpg") }} alt="">
                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-md-12">
                            <div class="bg-grad rounded-4 p-5 text-start">
                                ...
                                <h3 class="text-white ff-vb">“پذیرای ایده ها و رویکردهای جدید باشید. مهارت های حل مسئله خود را توسعه دهید.”</h3>
                            </div>
                        </div>
                        <!-- Image -->
                        <div class="col-sm-6 col-md-12 col-lg-6">
                            <img class="rounded-4" src={{ asset("assets/images/about/10.jpg") }} alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pt-0 pt-md-5">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8">
                    <h2>درباره آکادمی</h2>
                    <p class="mb-0">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 position-relative">
                    ...
                    <figure class="position-absolute top-0 start-0 d-inline-block mt-n3">
                        <svg style="transform: scale(-1,1)" width="180" height="188" viewBox="0 0 379 395" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Image -->
                    <img src={{ asset("assets/images/about/06.jpg") }} class="rounded" alt="">
                </div>
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    ...
                    <ul class="list-group list-group-borderless mt-4">
                        <li class="list-group-item d-flex">
                            <i class="bi bi-patch-check-fill text-success me-2"></i>راه اندازی و نصب زمان کمتری می برد
                        </li>
                        <li class="list-group-item d-flex">
                            <i class="bi bi-patch-check-fill text-success me-2"></i>نرم افزار حرفه ای و آسان برای استفاده
                        </li>
                        <li class="list-group-item d-flex">
                            <i class="bi bi-patch-check-fill text-success me-2"></i>مناسب برای هر دستگاهی با طراحی پیکسلی عالی
                        </li>
                        <li class="list-group-item d-flex">
                    ...
                    <div class="row mt-3 g-4">
                        ...
                        <div class="col-md-6">
                            <div class="overflow-hidden">
                                <h6>زبان ها</h6>
                                <div class="progress progress-sm bg-primary bg-opacity-10">
                                    <div class="progress-bar bg-primary aos" role="progressbar" data-aos="slide-left" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col-md-6">
                            <div class="overflow-hidden">
                                <h6>مدرسان</h6>
                                <div class="progress progress-sm bg-primary bg-opacity-10">
                                    <div class="progress-bar bg-primary aos" role="progressbar" data-aos="slide-left" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 95%;" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/microsoft.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/linkedin.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/netflix.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/coca-cola.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/envato.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/android.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/shippable.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/algolia.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/importio.svg") }} alt="">
                    </div>
                </div>
                <!-- Logo item -->
                <div class="col-6 col-sm-4 col-lg-2">
                    <div class="p-4 grayscale text-center">
                        <img src={{ asset("assets/images/client/yamaha.svg") }} alt="">
                    </div>
                </div>
            </div>
        </div>
