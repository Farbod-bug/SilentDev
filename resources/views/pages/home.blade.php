                ...
                <div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
                    ...
                    <form class="border rounded p-2 mb-4">
                        <div class="input-group">
                            <input class="form-control border-0 me-1" type="search" name="search" placeholder="جستجو..." value="{{ Request::input('search') }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card shadow-hover overflow-hidden bg-transparent">
                        <div class="position-relative">
                            <!-- Image -->
                            <img class="card-img-top" src="{{ Voyager::image($course->image) }}" alt="Card image">
                            <!-- Overlay -->
                                ...
                                <div class="w-100 mt-auto d-inline-flex">
                                    <div class="d-flex align-items-center bg-white p-2 rounded-2">
                                        ...
                                        <div class="avatar avatar-sm me-2">
                                            <img class="avatar-img rounded-1" src="{{ Voyager::image($course->teacher->image) }}" alt="avatar">
                                        </div>
                                        <!-- Avatar info -->
                                        <div>
                                            <h6 class="mb-0"><a href="#" class="text-dark">{{ $course->teacher->name . ' ' . $course->teacher->last_name }}</a></h6>
                                            <span class="small">مدرس</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div class="hstack gap-2">
                                    <a href="#" class="badge bg-orange bg-opacity-10 text-orange">
                                        @switch($course->level)
                                                @case('medium')
                                                    {{ 'متوسط' }}
                                                    @break
                            ...
                            <!-- Title -->
                            <h5 class="card-title fw-normal"><a href="{{ route('course' , $course->slug) }}">{{ $course->title }}</a></h5>
                            <!-- Rating -->
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="h6 fw-light mb-0 me-3"><i class="far fa-clock text-danger me-2"></i>{{ $course->hour }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h2 class="fs-3 fw-bold">
                        <span class="position-relative z-index-9">مربیان</span>
                        <span class="position-relative z-index-1">مجرب آکادمی
                            <!-- SVG START -->
                            <span class="position-absolute top-50 start-50 translate-middle z-index-n1">
                    ...
                    <p class="mb-0">دانش خود را با کارشناسان مجرب افزایش دهید.</p>
                </div>
            </div>
                ...
                <div class="tiny-slider arrow-round arrow-creative arrow-blur">
                    <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false" data-items="4" data-items-lg="3" data-items-md="2" data-items-xs="1">
                        ...
                        <div class="card bg-transparent">
                            <div class="position-relative">
                                <!-- Image -->
                                <img src="{{ Voyager::image($teacher->image) }}" style="height: 300px" class="card-img" alt="course image">
                                <!-- Overlay -->
                            ...
                            <div class="card-body text-center">
                                <!-- Title -->
                                <h5 class="card-title"><a href="#">{{ $teacher->name . ' ' . $teacher->last_name }}</a></h5>
                                <p class="mb-2">{{ $teacher->title }}</p>
                                <!-- Rating -->
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-12 position-relative z-index-1">
                    ...
                    <div class="bg-grad-pink p-4 p-sm-5 rounded position-relative z-index-n1 overflow-hidden">
                        ...
                        <figure class="position-absolute top-50 end-0 translate-middle-y">
                            <svg style="transform: scale(-1,1)" width="355.6px" height="396.1px">
                        ...
                        <div class="row g-3 align-items-center justify-content-lg-end position-relative py-4">
                            <!-- Title -->
                            <div class="col-md-6">
                                <h2 class="text-white">مدرس شویـد!</h2>
                                <p class="text-white mb-0">به هزاران دانش آموز آموزش دهید و به راحتی درآمد کسب کنید!</p>
                            </div>
                            <!-- Button -->
                            <div class="col-md-6 col-lg-3 text-md-end">
                                <a href="#" class="btn btn-white mb-0">ثبت نام</a>
                            </div>
                        </div> <!-- Row END -->
                    </div>
                </div>
